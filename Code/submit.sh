...
echo "Step 1: configuring inlist"
python inlist.py

# (2) download input photometry
echo "Step 2: Fetching input photometry via Gaia Archive, given Gaia DR3 source IDs"
python 3_Prepare_Input_Params_Photometry.py

# (3) photometric outlier clipping by carrying out blackbody fitting.
echo "Step 3: Photometric outlier clipping (blackbody fitting)"
...
echo "Step 6: Collecting the SED-fitting results."
